...
class TestMVTecDataModule:
    ...
    def test_val_and_test_dataloaders_has_mask_and_gt(self, data_module):
        """
        Validation and Test dataloaders should return filenames, image, mask and label
        """
...
class TestDenormalize:
    ...
    def test_representation(self):
        """
        Test Denormalize representation should return string Denormalize()
        """
...
class TestToNumpy:
    ...
    def test_to_numpy_image_pixel_values(self, data_sample):
        """
        Test ToNumpy should return an array whose pixels in the range of [0, 256]
        """
