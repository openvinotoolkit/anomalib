...
class _TestAnomalibDataModule:
    ...
    def test_datamodule_has_dataloader_attributes(self, datamodule: AnomalibDataModule, subset: str) -> None:  # noqa: PLR6301
    ...
    def test_datamodule_from_config(self, fxt_data_config_path: str) -> None:  # noqa: PLR6301
        # 1. Wrong file path:
