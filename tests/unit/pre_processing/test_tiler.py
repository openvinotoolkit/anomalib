...
def test_tiler_handles_single_image_without_batch_dimension(
    image_size, tile_size, stride, shape, use_random_tiling, device
):
...
def test_tile_size_cannot_be_larger_than_image_size(device):
...
def test_untile_non_overlapping_patches(tile_size, kernel_size, stride, image_size, device):
...
def test_untile_overlapping_patches(image_size, kernel_size, stride, remove_border_count, tile_size, mode, device):
...
def test_divisible_tile_size_and_stride(image_size, tile_size, stride, mode, device):
