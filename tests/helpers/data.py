...
class DummyImageDatasetGenerator(DummyDatasetGenerator):
    ...
    Examples:
        ...
        >>> dataset_generator = DummyImageDatasetGenerator(data_format="mvtec_ad", num_train=10, num_test=10)
        >>> dataset_generator.generate_dataset()

        In order to provide a specific directory to save the dataset, use the ``root`` argument.
        >>> dataset_generator = DummyImageDatasetGenerator(data_format="mvtec_ad", root="./datasets/dummy")
        >>> dataset_generator.generate_dataset()

        It is also possible to use the generator as a context manager.
        >>> with DummyImageDatasetGenerator(data_format="mvtec_ad", num_train=10, num_test=10) as dataset_path:
        >>>     some_function()
    ...
    def __init__(
        self,
        data_format: DataFormat | str = "mvtec_ad",
        root: Path | str | None = None,
    ...
    def _generate_dummy_mvtec_ad_dataset(
        self,
        normal_dir: str = "good",
    ...
    def _generate_dummy_btech_dataset(self) -> None:
        ...
        self._generate_dummy_mvtec_ad_dataset(normal_dir="ok", abnormal_dir="ko", mask_suffix="")
    ...
    def _generate_dummy_visa_dataset(self) -> None:
        ...
        self._generate_dummy_mvtec_ad_dataset(normal_dir="good", abnormal_dir="bad", image_extension=".jpg")
