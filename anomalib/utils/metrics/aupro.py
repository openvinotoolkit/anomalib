...
from anomalib.utils.metrics.pro import connected_components, pro_score
...
class AUPRO(Metric):
    ...
    def update(self, predictions: Tensor, targets: Tensor) -> None:  # type: ignore  # pylint: disable=arguments-differ
        ...
        self.n_regions.append(torch.tensor(n_comps - 1))  # pylint: disable=not-callable
    ...
    def compute(self) -> Tensor:
        ...
        return auc(fpr, torch.hstack(pro_scores))
