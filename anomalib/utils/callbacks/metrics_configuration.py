...
from anomalib.utils.metrics import metric_collection_from_names_or_dicts
...
class MetricsConfigurationCallback(Callback):
    ...
    def setup(
        ...
        if isinstance(pl_module, AnomalyModule):
            pl_module.image_metrics = metric_collection_from_names_or_dicts(image_metric_names, "image_")
            pl_module.pixel_metrics = metric_collection_from_names_or_dicts(pixel_metric_names, "pixel_")
