...
anomalib train \
    ...
    --visualization.save true \
    --visualization.save_path results/visualizations
...
anomalib predict \
    ...
    --visualization.save true \
    --visualization.save_path predictions/torch_visualizations
...
anomalib predict \
    ...
    --visualization.save true \
    --visualization.save_path predictions/onnx_visualizations
