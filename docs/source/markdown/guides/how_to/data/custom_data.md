...
want to train a segmentation model that will be able to detect the
abnormal regions in the test set.

### With Normal and Abnormal Images

We could use [Folder](../../reference/data/image/folder.md) datamodule to train a model on this dataset.
