...
from anomalib.models.ensemble.ensemble_prediction_data import EnsemblePredictionData
...
class EnsemblePredictionJoiner(ABC):
    ...
    def __init__(self, ensemble_predictions: EnsemblePredictionData, tiler: EnsembleTiler) -> None:
