"""Anomaly Detection via Revisiting Reverse Distillation from One-Class Embedding.
...
from .loss import RevisitingReverseDistillationLoss
from .torch_model import RevisitingReverseDistillationModel


class RevisitingReverseDistillation(AnomalyModule):
    ...
    def __init__(
        ...
        self.model: RevisitingReverseDistillationModel
        self.loss = RevisitingReverseDistillationLoss()
