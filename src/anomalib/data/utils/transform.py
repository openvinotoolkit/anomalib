...
def get_transforms(
    ...
    # Check if ToRGB is already in the transforms. If not add it to the beginning.
    if not any(isinstance(t, ToRGB) for t in transforms.transforms):
        transforms.transforms.insert(0, ToRGB())
